...
class image_CRUD {
    ...
    protected function _get_delete_url($value)
    {
    	...
    	$segment = $this->ci->uri->segment(1) . '/' . $this->ci->uri->segment(2). '/';
    	return site_url($segment . $rsegments_array[1].'/'.$rsegments_array[2].'/delete_file/'.$value);
    }
	...
	protected function getState()
	{
		...
		if(isset($rsegments_array[3]) && is_numeric($rsegments_array[3]))
		{
			...
			$upload_url = site_url($segment . $rsegments_array[1].'/'.$rsegments_array[2].'/upload_file/'.$rsegments_array[3]);
			$ajax_list_url  = site_url($segment . $rsegments_array[1].'/'.$rsegments_array[2].'/'.$rsegments_array[3].'/ajax_list');
			$ordering_url  = site_url($segment . $rsegments_array[1].'/'.$rsegments_array[2].'/ordering');
			$insert_title_url  = site_url($segment . $rsegments_array[1].'/'.$rsegments_array[2].'/insert_title');
		...
		{
			$upload_url = base_url($segment . $rsegments_array[1].'/'.$rsegments_array[2].'/upload_file');
			$ajax_list_url  = base_url( $segment . $rsegments_array[1].'/'.$rsegments_array[2].'/ajax_list');
			$ordering_url  = base_url($segment .$rsegments_array[1].'/'.$rsegments_array[2].'/ordering');
			$insert_title_url  = base_url($segment .$rsegments_array[1].'/'.$rsegments_array[2].'/insert_title');
